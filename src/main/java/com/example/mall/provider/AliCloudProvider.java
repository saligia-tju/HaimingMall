package com.example.mall.provider;
...
public class AliCloudProvider {
    ...
    public String upload(InputStream fileStream, String fileName) {
        ...
        String key = "mallpictures/" + generatedFileName;
        ...
        //公有url链接
        if (putObjectResult != null) {
            String url = "https://haiming-community.oss-cn-beijing.aliyuncs.com/mallpictures/" + generatedFileName;
            ossClient.shutdown();
            return url;
